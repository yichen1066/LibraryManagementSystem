...
wxColour IncColor(const wxColour& from, unsigned char delta) {
  return wxColour(IncUChar(from.Red(), delta), IncUChar(from.Green(), delta), IncUChar(from.Blue(), delta));
}

wxColour DecColor(const wxColour& from, unsigned char delta) {
  return wxColour(DecUChar(from.Red(), delta), DecUChar(from.Green(), delta), DecUChar(from.Blue(), delta));
}
