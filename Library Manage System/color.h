#ifndef CSUI_COLOR_H_
#define CSUI_COLOR_H_
#pragma once
...
struct Color {
  ...
  static wxColour Get(const wxChar* const color_name);
...
wxColour IncColor(const wxColour& from, unsigned char delta = 0);

// Example: DecColor(wxColour(125, 125, 125), 1) -> wxColour(124, 124, 124)
wxColour DecColor(const wxColour& from, unsigned char delta = 0);
